...
public class MySession extends Session {
    ...
    public int userId;
    public String uu;// this is username of user in the session
    public String pp;// this is password of user in the session
        ...
        if (this.player != null) {
            ...
            try {
                ...
                if (player != null) {
                    ...
                    // Service.getInstance().sendThongBaoOK(this, "Ngọc rồng sao đen sẽ mở lúc 21h
                    // hôm nay");
                }
            } catch (Exception e) {
                if (player != null) {
